...
use idx 0 to 3 to separate four side 0 is north 1 is right 3 is left  can think idx is a pointer which turn Countercirclewise  
so every time L or R (idx+curinstruction)%4 can get new direction remember L R only change idx and G can change x,y 
